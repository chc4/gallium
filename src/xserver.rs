...
pub use x11::xlib::{KeyCode,KeySym,Screen,Window};
pub use x11::xlib::Window as XWindow;
=======
>>>>>>> parent of a3f5ab3... use rust-xcb
...
impl XServer {
    ...
    pub fn map(&mut self,wind: Window){
        ...
        get_property(&self.conn, false, wind, _NET_WM_NAME, 
    }
    ...
    pub fn get_atom(&mut self, s: &str) -> Atom {
        unsafe {
            ...
            intern_atom(&self.conn, false, s).get_reply()
        }
    }
